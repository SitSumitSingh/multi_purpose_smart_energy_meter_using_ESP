...
void setup() {
  ...
  emon1.voltage(voltagePin1, 35, 1.7);
  emon1.current(currentPin1, 31);
  emon2.voltage(voltagePin2, 35, 1.7);
  emon2.current(currentPin2, 31);
}
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    totalCost1 = totalEnergy1 * costPerKWh;
    totalCost2 = totalEnergy2 * costPerKWh;
    ...
    digitalWrite(relay1, (realPower1 > 100) ? HIGH : LOW);
    digitalWrite(relay2, (realPower2 > 100) ? HIGH : LOW);
